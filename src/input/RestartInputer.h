...
class RestartInputer {
	public :
		...
		void getKDFIB_m(double & kdfib_m, const int &cid);
		void getKDHUM_m(double & kdhum_m, const int &cid);
		void getKDMIN_m(double & kdmin_m, const int &cid);
		void getKDSLOW_m(double & kdslow_m, const int &cid);
		void getRP(double & RP, const int &cid);
		void getTVEG(double & TVEG, const int &cid);
