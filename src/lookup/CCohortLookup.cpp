...
void CCohortLookup::init(string & inicalifile){
	...
	fctr >> vegtypei; 
  	...
  	fctr >> ini_kdcfib_m[drgtypei][vegtypei] >> comma >> order_kdcfib_m[drgtypei][vegtypei];
  	fctr >> ini_kdchum_m[drgtypei][vegtypei] >> comma >> order_kdchum_m[drgtypei][vegtypei];
  	fctr >> ini_kdcminfast_m[drgtypei][vegtypei] >> comma >> order_kdcminfast_m[drgtypei][vegtypei];
  	fctr >> ini_kdcminslow_m[drgtypei][vegtypei] >> comma >> order_kdcminslow_m[drgtypei][vegtypei];
