	...
	class CohortLookup {
  		public:
    		...
    		///calibration related
 			...
 			float kdcfib_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
 			float kdchum_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
 			float kdcmin_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
 			float kdcslow_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
 			float rpc[MAX_DRG_TYPE][MAX_VEG_TYPE];
 			float tvegc[MAX_DRG_TYPE][MAX_VEG_TYPE];
