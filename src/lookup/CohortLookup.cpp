...
void CohortLookup::assignVegetationParams(){
	...
	float dumtmin[] = {-1.0, -1.0, -1.0, -8.0 };
	float dumtoptmin[] = {5.5, 5.5, 5.5,14.2 };
	float dumtoptmax[] = {20., 20.0,20.0, 22.4};
	float dumtmax[] = {35., 35.0,35.0,  29.0};
	float dumraq10a0[] = {2.35665000, 2.35665000, 2.35665000, 2.35665000}; //2.35665000
	...
	float dumcov[] = {-0.001954, -0.000292, -0.0005673,-0.001571 }; //yuan 
    ...
    float dumvegc[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{237.0, 17483, 9000, 3250},
    	    { 237.0, 17483, 9000,  4000}};//D
...
void CohortLookup::assignLeafParams(){
	...
	float dumm1[] = {15.206 , 38.57, 28.55, 19.62};                 //redone by Yuan (2009):tudra, aspen, ws, dry-bs, wet-bs
...
void CohortLookup::assignMicrobeParams(){
	...
	float dumsolc[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{70066.0, 5907.0, 9940.0, 14439}, //dry
			                                     {70066.0, 5907.0, 9940.0,  19033}};//wet

	float dumsoln[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{2335, 326, 460.0,  548},   //dry
			                                     {2335, 326, 460.0,  671}};	//wet

	float dumavln[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{0.4, 1.65, 1.50,  1.00},
			                                     {0.4, 1.65, 1.50,  0.50}};
 	float dumnup[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{0.8, 1.267, 0.728, 1.48},
			 		                            {0.8, 1.267, 0.728, 1.48}};//
    ...
    float dumkdcfib_m[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{0.003216, 0.003163, 0.01211, 0.003620},
           	                                       {0.003216, 0.003163, 0.01211, 0.007223}};
    float dumkdchum_m[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{0.001895, 0.000916, 0.003525, 0.000524},
           	                                       {0.001895, 0.000916, 0.003525, 0.002085}};
    float dumkdcmin_m[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{0.0000625, 0.008032, 0.001438, 0.002716},
           	                                           {0.0000625, 0.008032, 0.001438, 0.000854}};
    float dumkdcslow_m[MAX_DRG_TYPE][MAX_VEG_TYPE] = {{0.00000625, 0.0008032, 0.0001438, 0.0002716},
           	                                           {0.00000625, 0.0008032, 0.0001438, 0.0000854}};
	...
	for (int ic =0; ic<MAX_VEG_TYPE; ic++){
		...
		for(int id =0; id<MAX_DRG_TYPE; id++){
			...
			kdcfib_m[id][ic] = dumkdcfib_m[id][ic];
			kdchum_m[id][ic] = dumkdchum_m[id][ic];
			kdcmin_m[id][ic] = dumkdcmin_m[id][ic];
			kdcslow_m[id][ic] = dumkdcslow_m[id][ic];
		}
...
void CohortLookup::assignRootParams(){
    ...
    float dum_frprod_010[] =  {15.2, 2.2, 51.95, 26.34 }; //15.2 15.2
    float dum_frprod_1020[] = {20.3, 46.41, 22.42,54.57}; //30.3 20.3
    float dum_frprod_2030[] = {35.5, 33.11, 11.05,13.48 }; //25.5 35.5
    float dum_frprod_3040[] = {19.0, 11.59,  5.3, 2.64 }; //19.0 19.0
    float dum_frprod_4050[] = {10.0, 2.37, 5.34, 0.6}; //10.0 10.0
    float dum_frprod_5060[] = {0.0, 1.7,  2.97, 0.58};
    ...
    float dum_rootdp4gpp[]= {0.05, 0.05, 0.01,  0.05};
