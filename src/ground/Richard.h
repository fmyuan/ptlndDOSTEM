...
class Richard{
	...
	private:
	    ...
	    void iterate(Layer *fstsoill,const double & trans, const double & evap,const double & infil, const double & drain);
	    int updateOneTimeStep(Layer *fstsoill,const double & trans, const double & evap,const double & infil, const double & drain);
	    int updateOneIteration(Layer *fstsoill,const double & trans, const double & evap,const double & infil, const double & drain);
