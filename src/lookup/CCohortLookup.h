	...
	class CCohortLookup{
  		public:
			...
			float humthick[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			...
  			float ini_kdcfib_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			float ini_kdchum_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			float ini_kdcminfast_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			float ini_kdcminslow_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
    		...
    		float order_nmax[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			...
  			float order_kdcfib_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			float order_kdchum_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			float order_kdcminfast_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
  			float order_kdcminslow_m[MAX_DRG_TYPE][MAX_VEG_TYPE];
	};
